...
help:
	...
	@echo "                                        Example: make verify-library-loads ARGS=rust/target/release/liblibsignal_frb.dylib"
...
verify-release-artifacts:
	@python3 scripts/verify_release_artifacts.py --crate-name libsignal_frb $(ARGS)
