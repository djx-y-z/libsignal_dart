...
final class ServerCertificate {
  ...
  factory ServerCertificate.fromPointer(Pointer<SignalServerCertificate> ptr) {
    return ServerCertificate._(ptr); // coverage:ignore-line
  }
  ...
  Uint8List serialize() {
    ...
    try {
      final error = signal_server_certificate_get_serialized(
        outPtr,
        constPtr.ref,
      );
  ...
  Uint8List get certificate {
    ...
    try {
      final error = signal_server_certificate_get_certificate(
        outPtr,
        constPtr.ref,
      );
  ...
  Uint8List get signature {
    ...
    try {
      final error = signal_server_certificate_get_signature(
        outPtr,
        constPtr.ref,
      );
  ...
  int get keyId {
    ...
    try {
      final error = signal_server_certificate_get_key_id(outPtr, constPtr.ref);
