...
import 'package:libsignal/src/platform/platform_io.dart';
...
void main() {
  group('nativeAssetSearchPaths', () {
    test('probes the directory `flutter test` installs the library into', () {
      expect(
        nativeAssetSearchPaths('liblibsignal_frb.so'),
        contains('build/native_assets/${hostAssetDir()}/liblibsignal_frb.so'),
        reason:
