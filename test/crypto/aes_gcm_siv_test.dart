...
void main() {
  ...
  group('Aes256GcmSiv', () {
    ...
    // Note: Tamper detection tests are skipped because libsignal native
    // library may crash when retrieving error messages for decryption
    // failures. This is a known limitation. The tamper detection functionality
    // itself works correctly - it's only the error handling that crashes.
