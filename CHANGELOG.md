...
- **libsignal v0.99.0** — internal/dependency update, no public-API impact

#### Changed

- Update libsignal native library to v0.99.0 ([compare](https://github.com/signalapp/libsignal/compare/v0.97.4...v0.99.0))
  - Upstream changes are limited to net/registration, chat gRPC helpers, and tooling updates — none of which this library exposes
...
[Unreleased]: https://github.com/djx-y-z/libsignal_dart/compare/v6.1.0...HEAD
