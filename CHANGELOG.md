...
- **libsignal v0.92.0** — latest upstream native library
- **libsignal_frb v2.0.0** — Rust FFI bindings

#### Changed

- Update libsignal native library to v0.92.0 ([release notes](https://github.com/signalapp/libsignal/releases/tag/v0.92.0))
