...
- **libsignal v0.93.0** — internal improvements and updates
- **libsignal_frb v2.0.2** — Rust FFI bindings

#### Changed

- Update libsignal native library to v0.93.0 ([release notes](https://github.com/signalapp/libsignal/releases/tag/v0.93.0))
  - Internal refactors and optimizations across various modules
  - Improvements to key management and message handling
