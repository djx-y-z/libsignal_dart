...
- **libsignal v0.94.2** — internal improvements and updates
- **libsignal_frb v4.0.1** — Rust FFI bindings

#### Changed

- Update libsignal native library to v0.94.2 ([release notes](https://github.com/signalapp/libsignal/releases/tag/v0.94.2))
  - Networking improvements: enhanced gRPC/H2 transport capabilities
  - Key Transparency: improved logging and monitoring features
...
[Unreleased]: https://github.com/djx-y-z/libsignal_dart/compare/v5.0.1...HEAD
