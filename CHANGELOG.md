...
- **libsignal v0.92.2** — dependency updates and improvements
- **libsignal_frb v2.0.1** — Rust FFI bindings

#### Changed

- Update libsignal native library to v0.92.2 ([release notes](https://github.com/signalapp/libsignal/releases/tag/v0.92.2))
  - Dependency updates and performance enhancements
...
[Unreleased]: https://github.com/djx-y-z/libsignal_dart/compare/v3.0.2...HEAD
