...
- Update libsignal native library to v0.99.1 ([compare](https://github.com/signalapp/libsignal/compare/v0.97.4...v0.99.1))
  - Upstream changes are limited to chat and backup service updates, logging improvements, and node support changes — none of which this library exposes
