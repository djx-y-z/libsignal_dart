/// Update checking utilities for libsignal.
///
...
Future<Map<String, dynamic>> _fetchLatestRelease() async {
  final body = await githubApiGet(
    ...
    userAgent: 'libsignal-update-checker',
  );
