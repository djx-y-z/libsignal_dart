...
Development scripts for managing the libsignal Dart package.
...
Check for new libsignal releases and optionally update rust/Cargo.toml:
...
# 1. Edit rust/Cargo.toml - update libsignal-protocol tag to new version
# 2. Update Cargo.lock
...
The `check-libsignal-updates.yml` workflow:
1. Runs daily to check for new libsignal releases
